...
export function App(): JSX.Element {
  return <ErrorBoundary><Routes><Route element={<ApplicationLayout />}><Route path="/" element={<HomePage />} /><Route path="/settings" element={<LegacyGlobalRedirect path="settings" />} /><Route path="/devices/:deviceId" element={<LegacyDeviceRedirect />} /><Route path="/devices/:deviceId/camera" element={<CameraPage />} /><Route path="/devices/:deviceId/schedule" element={<SchedulePage />} /><Route path="/devices/:deviceId/:tab" element={<LegacyDeviceRedirect />} /><Route path="*" element={<Navigate to="/" replace />} /></Route></Routes></ErrorBoundary>;
}
